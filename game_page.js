...
function send() {
  ...
  if (word.length < 5) {
    return (document.getElementById("msg-label").innerHTML =
      "Por-favor digite uma palavra com cinco letras, ou eu te bano para sempre e pego seu ip");
  }
  // remover o t de  todos os chars
...
function check() {
  ...
  if ((question_turn = "player1")) {
    ...
    document.getElementById("player_question").innerHTML =
      "turno de perguntas " + player2_name;
  } else {
    question_turn = "player1";
    document.getElementById("player_question").innerHTML =
      "turno de perguntas " + player1_name;
  }

  if ((answer_turn = "player1")) {
    answer_turn = "player2";
    document.getElementById("player_answer").innerHTML =
      "respostas " + player2_name;
  } else {
    answer_turn = "player1";
    document.getElementById("player_answer").innerHTML =
